...
public class Operacja extends Blok implements Cloneable {
	...
	public String toString() {
		return "Op. "+this.getNumerOperacji()+" zad."+this.getNumerZadania() +" czas st: "+this.getCzasStartu()
		+" czas zakonczenia: "+(this.getCzasStartu()+czasTrwaniaPraktyczny)+" czas trw wg inst: "+
