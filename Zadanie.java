...
//		}
	...
	public String toString() {
		return "Zadanie " + numerZadania + " Operacja 1, czas trwania: "+operacje[0].getCzasTrwania()+", maszyna: " + operacje[0].getMaszyna()+
			...
			public void wyczyszcOperacje() {
				operacje[0].setCzasStartu(0);
				operacje[0].setCzasTrwaniaPraktyczny(operacje[0].getCzasTrwania());
				operacje[1].setCzasStartu(0);
				operacje[1].setCzasTrwaniaPraktyczny(operacje[0].getCzasTrwania());
			}
